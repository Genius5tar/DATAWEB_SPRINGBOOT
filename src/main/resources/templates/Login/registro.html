<%-- 
    Document   : registro
    Created on : 14/05/2023, 2:39:11 a. m.
...
<body>
    <div class="row justify-content-center align-items-center ">
        ...
        <div class="container-xs col-4">
            <form class="" method="POST" action="/Usuarios" >
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="user_type" maxlength="1" >
                </div>
         
                <div class="p-3 m-0 border-0 justify-content-space-eveling">
                <button type="submit" class="btn btn-success " name="accion" value="Registro" >Registrar</button>
